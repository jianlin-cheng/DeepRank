...
print "\n\n##### (1) Run feature generation\n\n";
print("perl $H_script/P0_run_Proq3.pl $targetname $seqfile $dir_models $dir_output\n");
$status = system("perl $H_script/P0_run_Proq3.pl $targetname $seqfile $dir_models $dir_output");
...
$all_features_list2 = "feature_proq2,feature_proq3_lowres,feature_proq3_highres,feature_proq3";
