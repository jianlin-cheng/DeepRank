...
print "\n\n##### (1) Run feature generation\n\n";
print("perl $H_script/P0_run_voronota.pl $targetname $seqfile $dir_models $dir_output\n");
$status = system("perl $H_script/P0_run_voronota.pl $targetname $seqfile $dir_models $dir_output");
...
$all_features_list2 = "feature_voronota";
